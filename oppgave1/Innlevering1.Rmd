...
knitr::include_graphics("Edworthsgraf1.png")
...
Dette ender med at Trine og Erna sine indifferanse kurver flytter seg og når et nytt skjerings punkt i U2 der både Trine og Erna når er i et nytt nyttenivå som gir et skjeringspunkt som ligger på 1 nyre.
...
Aksjemarkedet er som alle andre markeder, men her finner du få statlige inngrep som påkrevd kvartal rapport, månedsrapport og årsrapport, som tillater investorer å vite hvordan det står til og om det er vært å forsette å investere eller ikke. Fjerner vi dette statlige inngrepet ender vi med at flere selskaper ikke viser aktuel data for hva som skjer som leder til uheldige handler og misbruk. Der selskap kan falsifisere eller velge å opplyse viktige tall og data som kan påvirke valg som investorer kan ta for optimale valg.
...
Aksjemarkedet er et frittmarked der en paretoeffektiv fordeling vil mest sansynelig skje av at folk vil investere i lovende og profitt skapende aksjer. Dette vil lede til at et paretoeffektivt marked vil bli nådd der folk investerer i en pris der de tenker det vil tjene tilbake mer en de investerte. Dette leder til at produsenten av aksjen får mer budsjett der det kan få bedre resultater som leder til at det kan bli en økning i verdi som oppfyller sammensettningseffekten der supplyen(verdi) av askjene går opp imens demand(akjser) øker også jo bedre et selskap gjør det. Markedsvikt er noe som vil naturlig skje i et aksjemarkedet som i alle andre marked. Dette kan gå ut på at aksjene kan tape all verdi med å gå konkurs foreksempel der det du har investert i mister all verdi. Jeg tror at selskaper som vil skjule årsrapporter, månedsrapporter osv, vil ikke bli investert i å dermed ender opp med at ressuser ikke blir allokert til disse selskapene som prøver å ikke gi denne informasjonen.
...
svar:
Vår forventede nytte blir 86.35, fordi vi har $E(Ü) = p1U(y1) + p2U(y2)$ der U(y) funksjonen vår er y^0,5
...
svar: Forsikringspremien ender på 4000, Dette får vi med å bruke formelen vår $\pi_i = (1+\alpha)p_iL$ hvor vi antar at $\alpha$ er 0 og L er størelsen på tapet som blir 8000, dette gir oss stykket
$\pi_i=0.5*8000$ = $\pi_i = 4000$. Så dette gir oss forsikringspremien på 4000.   
...
Dette lar oss vite at inntekts fordelingen i tromsø har blitt flyttet seg minimalt, og det er omtrent helt det samme.